...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Date picker minimum date (booking form)
    ...
    backToTopBtn.className = 'btn btn-warning position-fixed bottom-0 end-0 m-4 rounded-circle';
    ...
    console.log('Restaurant website scripts loaded successfully!');
});
